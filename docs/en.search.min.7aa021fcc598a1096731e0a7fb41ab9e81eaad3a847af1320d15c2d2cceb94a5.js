...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.233dbe9bb689d9893a62a7ec9cd1fdefc62469bcbc7ea243c9dbdf1237c7cb21.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e99c2802cc4639df9692a5aa3bf7c45262954a85c73f8964e1f5fad2e5972265.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f10ed92dfc350e0b66852836f09f98d0ec0f9052fcfc90c932673f7964ff2913.js',function(){input.required=false;search();});}
